...
class RightSidebarAlt extends StatefulWidget {
  const RightSidebarAlt({super.key});

  @override
  State<RightSidebarAlt> createState() => _RightSidebarAltState();
}
...
class _RightSidebarAltState extends State<RightSidebarAlt> {
  final _items = [
    SidebarItemData(
      title: "Layers",
